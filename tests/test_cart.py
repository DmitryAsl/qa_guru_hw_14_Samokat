...
class TestCart:
    def test_add_single_item_to_cart(self):
        ...
        try:
            ...
            main_page.add_product(param['product_name'])
            main_page.assert_result_addition_product_to_cart(param['product_name'])
            main_page.should_have_count_product_in_cart(1)
        finally:
    ...
    def test_remove_item_from_cart(self):
        ...
        try:
            ...
            main_page.add_product(param['product_name'])
            main_page.should_have_count_product_in_cart(1)
            main_page.remove_product(param['product_name'])
    ...
    def test_total_price_by_cart(self):
        ...
        try:
            main_page.search_product(param['search_phrace'])
            main_page.add_product(param['product_name_1'])
            main_page.add_product(param['product_name_2'])
            main_page.add_product(param['product_name_3'])
